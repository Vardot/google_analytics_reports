...
namespace Drupal\Tests\google_analytics_reports\Unit\GoogleAnalyticsReportsApiFeed;
 ...
 * @group google_analytics_report_apoi
 */
class GoogleAnalyticsReportsApiFeedTest extends UnitTestCase {
  ...
  protected function setUp() {
    parent::setUp();
    require_once dirname(dirname(__DIR__)) . '/mock.php';
    $config_map = [
